    ...
    <div className="modal-overlay" onClick={handleClose}>
      <div className="modal-card" onClick={(e) => e.stopPropagation()}>
        ...
        <section>
          ...
          <p>
            האפליקציה לוקחת את קובץ ה-OTC המקודד (הקידוד הידני של השאלות הפתוחות) ומייצרת ממנו
            את כל הקבצים הדרושים להעלאת התשובות המקודדות בחזרה לתוך השאלון ב-Decipher: קובץ
            .dat נפרד לכל שאלה, לוג ניקוי לשאלות "מודעות ספונטנית" (AB), וקובץ XML שמכיל את
            תכנות ה-Decipher עבור כל שאלה, מוכן להעתקה לשאלון.
          </p>
        </section>
        ...
        <section>
          ...
          <ol>
            ...
            <li>
              ...
              בקובץ ומציעה סוג לכל שאלה. בדקו את הסיווג ותקנו במידת הצורך, ולאחר מכן לחצו
              "הפקת קבצים".
            </li>
            <li>
              <strong>תוצאות</strong> — כאן ניתן לראות תצוגה מקדימה של כל קובץ שהופק, ולהוריד את
              כולם יחד כקובץ zip אחד.
            </li>
          </ol>
        </section>
        ...
        <section>
          ...
          <ul>
            <li>
              <strong>רגילה</strong> — שאלה פתוחה "רגילה" (לא AB ולא סגורה+אחר). מופק עבורה קובץ
              .dat אחד עם כל התשובות המקודדות כפי שהן.
            </li>
            <li>
              <strong>AB — מודעות ספונטנית</strong> — זוג שאלות עם אותו שם ובסיומת a/b (למשל
              q5a ו-q5b): הראשונה היא TOM (הראשון שעולה בראש) והשנייה היא "אחרים שעלו". עבור
              זוג כזה יש לבחור "תשובה לניקוי" (בדרך כלל "לא יודע/לא מכיר") — האפליקציה מנקה
              אוטומטית כפילויות של התשובה הזו בין שתי השאלות, כדי שלא תיספר פעמיים בניתוח
              המודעות הכוללת. לאחר הניקוי, קובץ ה-A הסופי מכיל רק את העמודה הראשונה (ה-TOM
              בלבד), וקובץ ה-B הסופי מכיל את כל עמודות הקוד המקוריות של A ושל B יחד (סה"כ
        ...
        <section>
          ...
          <p>
            ...
            הייצואים הבאים), או להעלות תבנית חד-פעמית לייצוא נוכחי בלבד — שתי האפשרויות זמינות
            במסך "מיפוי שאלות".
          </p>
        </section>
        </div>
